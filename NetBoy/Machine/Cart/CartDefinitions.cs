...
namespace NetBoy.Machine
{
    public static class CartDefinitions
    {
        ...
        public static string GetRomSize(byte code)
        {
            if (RomSizes.ContainsKey(code))
            {
        ...
        public static string GetRamSize(byte code)
        {
            if (RamSizes.ContainsKey(code))
            {
        ...
        public static string GetRegion(byte code)
        {
            if (DestinationCodes.ContainsKey(code))
            {
                return DestinationCodes[code];
            }
            return "Not Found.";
        }

        public static string GetCartrigeType(byte code)
        {
            if (CartridgeTypes.ContainsKey(code))
            {
                return CartridgeTypes[code];
            }
            return "Not Found.";
        }

        public static string GetOldCompany(byte code)
        {
            if (OldCompanies.ContainsKey(code))
            {
                return OldCompanies[code];
            }
            return "Not Found.";
        }
        public static string GetNewCompany(string code)
        {
            if (NewCompanies.ContainsKey(code))
            {
                return NewCompanies[code];
            }
            return "Not Found.";
        }
        ...
        private static Dictionary<string, string> NewCompanies = new Dictionary<string, string>()
        {
            { "00", "None" },
            { "01", "Nintendo R&D1" },
            { "08", "Capcom" },
